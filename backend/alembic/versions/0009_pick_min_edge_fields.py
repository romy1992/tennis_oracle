"""betting slip pick min edge fields

Revision ID: 0009_pick_min_edge_fields
Revises: 0008_global_update_runs
...
revision: str = "0009_pick_min_edge_fields"
down_revision: Union[str, None] = "0008_global_update_runs"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


VALUE_COLUMNS = {
    "suggested_min_edge_percent": sa.Float(),
    "min_edge_percent": sa.Float(),
}
