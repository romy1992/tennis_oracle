...
\restrict aHlv6fNUgyPmQG0fku16xDTdrxKgJN9XTWne6Z4gXfxKELXQ5DzltACi5xsSulC
...
ALTER TABLE IF EXISTS ONLY public.tournament DROP CONSTRAINT IF EXISTS tournament_tournament_key_key;
ALTER TABLE IF EXISTS ONLY public.tournament DROP CONSTRAINT IF EXISTS tournament_pkey;
ALTER TABLE IF EXISTS ONLY public.standing DROP CONSTRAINT IF EXISTS standing_pkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT IF EXISTS player_player_key_key;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT IF EXISTS player_pkey;
ALTER TABLE IF EXISTS ONLY public.fixture DROP CONSTRAINT IF EXISTS fixture_pkey;
ALTER TABLE IF EXISTS ONLY public.fixture DROP CONSTRAINT IF EXISTS fixture_event_key_key;
ALTER TABLE IF EXISTS ONLY public.event DROP CONSTRAINT IF EXISTS event_pkey;
ALTER TABLE IF EXISTS ONLY public.event DROP CONSTRAINT IF EXISTS event_event_type_key_key;
ALTER TABLE IF EXISTS public.tournament ALTER COLUMN id_tournament DROP DEFAULT;
ALTER TABLE IF EXISTS public.standing ALTER COLUMN id_standing DROP DEFAULT;
ALTER TABLE IF EXISTS public.player ALTER COLUMN id_player DROP DEFAULT;
ALTER TABLE IF EXISTS public.fixture ALTER COLUMN id_fixture DROP DEFAULT;
ALTER TABLE IF EXISTS public.event ALTER COLUMN id_event DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.tournament_id_tournament_seq;
DROP TABLE IF EXISTS public.tournament;
DROP SEQUENCE IF EXISTS public.standing_id_standing_seq;
DROP TABLE IF EXISTS public.standing;
DROP SEQUENCE IF EXISTS public.player_id_player_seq;
DROP TABLE IF EXISTS public.player;
DROP SEQUENCE IF EXISTS public.fixture_id_fixture_seq;
DROP TABLE IF EXISTS public.fixture;
DROP SEQUENCE IF EXISTS public.event_id_event_seq;
...
--
-- Name: event_id_event_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: fixture_id_fixture_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: fixture_id_fixture_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: player_id_player_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: player_id_player_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: standing_id_standing_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: standing_id_standing_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: tournament_id_tournament_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tournament_id_tournament_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: event id_event; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: fixture id_fixture; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: player id_player; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: standing id_standing; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: tournament id_tournament; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: standing; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: fixture_id_fixture_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: player_id_player_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: standing_id_standing_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: tournament_id_tournament_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: event event_event_type_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fixture fixture_event_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: player player_player_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tournament tournament_tournament_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict aHlv6fNUgyPmQG0fku16xDTdrxKgJN9XTWne6Z4gXfxKELXQ5DzltACi5xsSulC
